...
//go test x02_barrier* -run=TestBarrier/Correct_endpoints -v
//go test x02_barrier* -run=TestBarrier/One_endpoint_incorrect -v
// go test x02_barrier* -run=TestBarrier/Very_short_timeout -v
